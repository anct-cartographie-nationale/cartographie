...
Les données affichées dans cette cartographie proviennent du [DataSpace de l’ANCT](https://api.inclusion-numerique.anct.gouv.fr/api-doc/), qui centralise et expose les informations de l’inclusion numérique en France à travers une API.
