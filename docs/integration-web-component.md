...
```html
<link
  href="https://cdn.jsdelivr.net/npm/@gouvfr-anct/cartographie-nationale@6.13.7/dist-wc/cartographie-nationale.css"
  rel="stylesheet"
/>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@gouvfr-anct/cartographie-nationale@6.13.7/dist-wc/cartographie.umd.js"></script>
```
