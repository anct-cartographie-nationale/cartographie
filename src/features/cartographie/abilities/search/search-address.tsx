...
import { HighlightCommune, removeHighlightDecoupageAdministratif } from '@/features/cartographie/infrastructure';
import type { Address } from '@/libraries/address';
...
import { addressCombobox, addressOptions } from './address-combobox';
