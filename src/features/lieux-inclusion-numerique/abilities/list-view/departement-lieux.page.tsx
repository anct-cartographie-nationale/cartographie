...
import type { LieuListItem } from '@/features/lieux-inclusion-numerique/domain';
import { highlightDepartement } from '@/features/lieux-inclusion-numerique/infrastructure';
